...
The `apt` CLI itself must also be installed — the app is a GUI wrapper around it.
...
- `src/` — the apt adapter (command builders + output parsers) and `main.cpp`.
